...
public class TC0013_login_With_Client_Developer extends basePropertiesSeln{
	...
	public void logInWithPartnerClient_Development () throws IOException, InterruptedException {
		...
		dataDriven d=new dataDriven();
		  ArrayList<String> data=d.getData("login","Client/Developer");
	    ...
	    log.info("Verified that VoiceWatch Application login successfully with Clinet_Developer creadetial");
	    log.debug("Validate the requiment as Aceess Level= Client & Role=Developer");
