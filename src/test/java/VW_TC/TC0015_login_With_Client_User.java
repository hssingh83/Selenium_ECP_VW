...
public class TC0015_login_With_Client_User extends basePropertiesSeln{
	...
	public void logInWithPartnerClient_User () throws IOException, InterruptedException {
	    ...
	    log.info("Verified that VoiceWatch Application login successfully with Clinet_ User creadetial");
	    log.debug("Validate the requiment as Aceess Level= Client & Role=User");
