...
public class TC0012_login_With_Client_Custmer_Admin extends basePropertiesSeln{
	...
	public void logInWithPartnerClient_CustomerAdmin () throws IOException, InterruptedException {
	    ...
	    log.info("Verified that VoiceWatch Application login successfully with Clinet_Customer_Admin creadetial");
	    log.debug("Validate the requiment as Aceess Level=Client & Role=Customer_Admin");	 
