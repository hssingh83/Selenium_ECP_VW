...
public class TC0014_login_With_Client_Enhanced_User extends basePropertiesSeln{
	...
	public void logInWithPartnerClient_EnhancedUser () throws IOException, InterruptedException {
	    ...
	    log.info("Verified that VoiceWatch Application login successfully with Clinet_Enhanced User creadetial");
	    log.debug("Validate the requiment as Aceess Level= Client & Role=Enhamced User");	
